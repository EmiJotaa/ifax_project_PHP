				...
				<div class="form">
					<form action="" method="POST" enctype="multipart/form-data">
						<div class="campo title">
							<label>Título*</label>
							<input type="text" name="titulo" value="<?=$data['informacoes']['noticia'][0]['titulo']?>" required>
						</div>
						...
						<div class="campo imagens">
							<div class="item">
								<img src="<?=URL_BASE?><?=$data['informacoes']['noticia'][0]['imagem_principal']?>">
								<label>
									<input type="checkbox" name="excluir_imagem_principal" value="<?=$data['informacoes']['noticia'][0]['imagem_principal']?>">
									Excluir Imagem
								</label>
							</div>
						</div>
						...
						<div class="campo">
							...
							<select name="ativo" required>
								<option value="s" <?=($data['informacoes']['noticia'][0]['status'] === 's') ? 'selected' : '' ?> >Sim</option>
								<option value="n" <?=($data['informacoes']['noticia'][0]['status'] === 'n') ? 'selected' : '' ?> >Não</option>
							</select>
						</div>
						<div class="campo">
